                            ...
                            <div class="justify-start items-start gap-14 inline-flex">
                                <div class="justify-start items-start flex">
                                    <div
                                        ...
                                        <a href="detail_talent.blade.php" class="text-blue-500 text-base font-medium">Profile
                                        </a>
                                    </div>
                                </div>
                                <div class="justify-start items-start flex">
                                    <a href="statistik_detail.blade.php" class="py-1 justify-center items-center gap-5 flex">
                                        <div class="text-slate-500 text-base font-medium">
                                            Statistik</a>
...
<div class="mt-6 text-slate-500 font-medium text-xs text-gray-700">Nama Talent</div>
<p class="w-64 mt-2 font-medium text-xm text-black">Jude Belligham</p>

</div>

<div>
<div class="mt-4 text-slate-500 font-medium text-xs text-gray-700">Jenis Kelamin</div>
<p class="w-64 mt-2 font-medium text-xm text-black">laki laki</p>
</div>

</div>

<div class="ml-[80vh] block">
<div>
<div class="mt-6 text-slate-500 font-medium text-xs text-gray-700">Nomor Induk Pegawai</div>
<p class="w-64 mt-2 font-medium text-xm text-black">P1234-0089</p>
</div>

<div>
<div class="mt-4 text-slate-500 font-medium text-xs text-gray-700">Tanggal Lahir</div>
<p class="w-64 mt-2 font-medium text-xm text-black">12/10/2005</p>
</div>
 ...
 <div class="mt-6 text-base font-semibold text-gray-500">CV</div>
                        
 <button class="mt-3 px-7 py-2 bg-blue-600 text-white rounded cursor-pointer">
  Download CV
</button>
...
<div class="mt-8 text-slate-500 font-medium text-xs text-gray-700">Pengalaman</div>
<p class="w-64 mt-2 font-medium text-xm text-black">2 Tahun</p>
...
<div class="ml-[80vh] block">
<div>
<div class="mt-8 text-slate-500 font-medium text-xs text-gray-700">level</div>
<p class="w-64 mt-2 font-medium text-xm text-black">Junior</p>
</div>

</div>
</div>

<div class="mt-6 text-base text-xs font-semibold text-gray-500">Skill Set</div>
<div class="mt-3 flex justify-end">
  <button class="bg-white w-20 h-7 px-6 font-semibold text-gray-600 rounded border border-zinc-300 mr-2">Java</button>
  <button class="bg-white w-20 h-7 px-6 font-semibold text-gray-600 rounded border border-zinc-300 mr-2">Php</button>
  <button class="bg-white w-20 h-7 px-3 font-semibold text-gray-600 rounded border border-zinc-300 mr-2">Laravel</button>
  <button class="bg-white w-24 h-7 px-2 font-semibold text-gray-600 rounded border border-zinc-300 ">Front-End</button>
</div>
...
<div class="mt-9 text-slate-500 font-medium text-xs text-gray-700">E-mail</div>
<p class="w-64 mt-2 font-medium text-xm text-black">belligham@gmail.com</p>

</div>

<div>
<div class="mt-4 text-slate-500 font-medium text-xs text-gray-700">Biografi Vidio</div>
<p class="w-64 mt-2 font-medium text-xm text-black">youtube.com/akubiografi</p>
</div>
...
<div class="ml-[80vh] block">
<div>
<div class="mt-9 text-slate-500 font-medium text-xs text-gray-700">No HP/ Whatssapp</div>
<p class="w-64 mt-2 font-medium text-xm text-black">088447678215190</p>
</div>
